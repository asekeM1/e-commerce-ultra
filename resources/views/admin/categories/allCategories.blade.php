            ...
            <div class="card card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{route('add-categories')}}" class="btn btn-primary">Добавить категорию</a>
                    </div>
                </div>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        <div class="menu-item px-3">
                                            <a href="{{route('edit-categories', $cat->id)}}" class="menu-link px-3">Редактировать</a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a href="{{route('delete-categories', $cat->id)}}" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row">Удалить</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
