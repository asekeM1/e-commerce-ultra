                            ...
                            <td>
                                <div class="d-flex">
                                    <a href="../../demo1/dist/apps/ecommerce/catalog/edit-category.html" class="symbol symbol-50px">
                                        <span class="symbol-label" style="background-image:url({{asset('assets/media//stock/ecommerce/2.gif')}});"></span>
                                    </a>
                                    <div class="ms-5">
                                        <a href="../../demo1/dist/apps/ecommerce/catalog/edit-category.html" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name">Фен</a>
                                        <div class="text-muted fs-7 fw-bold">Our computers and tablets include all the big brands.</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="badge badge-light-primary">Электроника</div>
                            </td>
                            <td>
                                <div class="badge badge-light-success">100</div>
                            </td>
                            <td class="text-end">
